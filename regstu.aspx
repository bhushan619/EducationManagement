...
<script runat="server">
    ...
    { 
        ...
        try
        {
            if (dbc.check_already_student(Request["eml"].ToString()) == 1)
            {
            ...
            else
            {
                ...
                int insert_ok = dbc.insert_tblstudentdetail(Request["nm"].ToString(), Request["eml"].ToString(), Request["mob"].ToString(), Request["pas"].ToString(), verify);
