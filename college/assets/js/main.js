    ...
    $(function(){
        ...
        if ($(window).width() <= 767) {
            $('.nav-links>.dropdown>a').on('click', function(){
                if ($(this).parent().find('.CourseKatta-dropdown-menu-1').hasClass('dropdown-focus') == true) {
                    $(this).parent().find('.CourseKatta-dropdown-menu-1').removeClass('dropdown-focus');
                }
                else {
                    $('.nav-links .dropdown .CourseKatta-dropdown-menu-1').removeClass('dropdown-focus');
                    $(this).parent().find('.CourseKatta-dropdown-menu-1').addClass('dropdown-focus');
                }
            });
            $('.CourseKatta-dropdown-menu-1 .dropdown>a').on('click', function(){
                $(this).parent().find('.CourseKatta-dropdown-menu-2:first').toggleClass('dropdown-focus');
            });
            ...
            $('body').click(function (event) {
                ...
                if (
                    $('.CourseKatta-navbar').has(event.target).length == 0 && !$('.CourseKatta-navbar').is(event.target)
