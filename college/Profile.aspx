<%@ Page Title="" Language="C#" MasterPageFile="~/college/MasterPageClgNoAds.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="college_Profile" %>
        ...
        <div class="row">
            <div class="col-lg-5">
                <asp:Button ID="btnApply" CommandName="apply" Width="100%" runat="server" CssClass="pagebtn pagebtn-blue"
                    OnClick="btnApply_Click" Enabled="false" Text="Apply"></asp:Button>
            </div>
            <div class="col-lg-7">
                <asp:Button ID="btnVisit" Enabled="false" CommandName="visit" Width="100%" runat="server" CssClass="pagebtn pagebtn-blue"
    ...
    <div class="col-lg-2">
        <div class="coursekatta-layout-1">
            ...
            <div style="text-align: center">
                ...
                <asp:LinkButton ID="Button4" Width="100%" runat="server" CssClass="pagebtn pagebtn-blue" PostBackUrl="~/college/InstitituteSettings.aspx" Style="margin-top: 5px" Text="Page Settings"></asp:LinkButton>
