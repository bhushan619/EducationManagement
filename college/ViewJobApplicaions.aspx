<%@ Page Title="" Language="C#" MasterPageFile="~/college/MasterPageClgNoAds.master" AutoEventWireup="true" CodeFile="ViewJobApplicaions.aspx.cs" Inherits="college_ViewJobApplicaions" %>
    ...
    <div class="col-lg-7">
        ...
        <div id="profileView" runat="server">
            ...
            <div id="courses" class="container coursekatta-layout-1">
                <br />
                <label class="title-news" style="font-size: 22px">Job Applications</label>
