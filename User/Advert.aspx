<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPageUser.master" AutoEventWireup="true" CodeFile="Advert.aspx.cs" Inherits="User_Advert" %>
        ...
        <h2>Buy Post</h2>
            <div class="form-group">
                <asp:TextBox ID="TxtDescription" runat="server"
                    TextMode="MultiLine" Height="100px" CssClass="form-control" onkeypress="return this.value.length<=140" placeholder="Share your ideas, thoughts & plans... Limit is 160 Characters..!!"></asp:TextBox>
            </div>
            <div class="box-footer rlp-table" style="margin-top: -15px">
                ...
                <asp:LinkButton ID="Button1" runat="server" Text=" Buy" class="pagebtn fa fa-paper-plane pagebtn-blue pull-right" OnClick="btnPost_Click"></asp:LinkButton>
            </div>
                ...
                <div class="box-footer rlp-table" style="margin: 5px 0px">
                    ...
                    <div class='box-header with-border'>
                        <div class='user-block pull-left'>
                            ...
                            <span class='description'>Sponsored from - <%# String.IsNullOrEmpty(Eval("varFrom").ToString())?"Expired":Eval("varFrom").ToString() %>&nbsp;to&nbsp;<asp:Label ID="LblDate" runat="server" Text='<%#String.IsNullOrEmpty(Eval("varTo").ToString())?"Expired":Eval("varTo").ToString()%>'></asp:Label></span>
                        </div>
                        <!-- /.user-block -->
