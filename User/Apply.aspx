<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPageUserProfileViews.master" AutoEventWireup="true" CodeFile="Apply.aspx.cs" Inherits="User_Apply" %>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <asp:Button ID="Button1" CommandName="apply" Width="100%" runat="server" CssClass="pagebtn pagebtn-blue"
                            OnClick="Button1_Click" Text="Apply"></asp:Button>
                    </div>
                    <div class="col-lg-7">
               ...
               <br />
						 <table class="table table-bordered"  >
                             ...
                             <td class="text-right">
                                <asp:Label ID="Label1" runat="server" Text="Select Course"></asp:Label></td>
                                 <td colspan="2" align="left"> 
                                  <asp:DropDownList ID="ddlCourse" runat="server" CssClass="form-control" 
                                            DataSourceID="SqlDataSourceCourse" DataTextField="varCourseName" ValidationGroup="appy"
                                            DataValueField="varCourseName" AppendDataBoundItems="true">
                                      <asp:ListItem Value="Select">-- Select Course --</asp:ListItem>
                                        </asp:DropDownList>
                                     <asp:CompareValidator ControlToValidate="ddlCourse" ID="CompareValidator7"
                                             ValidationGroup="appy" ErrorMessage="Please select a course"
                               ...
                               <td colspan="2" align="left"><asp:Button ID="btnApply" runat="server" CssClass="pagebtn pagebtn-blue" 
                                        ValidationGroup="appy"     onclick="btnApply_Click" Text="Apply" /></td>
                               </tr>
