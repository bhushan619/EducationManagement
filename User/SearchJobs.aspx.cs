...
public partial class User_SearchJobs : System.Web.UI.Page
{
    ...
    public void loadsearch()
    {
        ...
        try
        {
            ...
            {
                SqlDataSourceHomeCollege.SelectCommand = "SELECT tblcollegedetails.intCollegeId, tblcollegedetails.isTutor, tblcollegedetails.varCollegeName, tblcollegedetails.varCollegeAddress, tblcollegedetails.varCollegeCity, tblcollegedetails.varCollegeState, tblcollegedetails.varContactOne, tblcollegedetails.varContactTwo, tblcollegedetails.varCollegeEmail, tblcollegedetails.varCollegeWeb, tblcollegedetails.varPhoto, tbljobs.varDesignation FROM tblcollegedetails INNER JOIN tbljobs ON tblcollegedetails.intCollegeId = tbljobs.intCollegeID where tbljobs.varDesignation like '%" + Request.QueryString["institute"].ToString() + "%'";
                LoadMap("SELECT tblcollegedetails.intCollegeId, tblcollegedetails.isTutor, tblcollegedetails.varCollegeName, tblcollegedetails.varCollegeAddress, tblcollegedetails.varCollegeCity, tblcollegedetails.varCollegeState, tblcollegedetails.varContactOne, tblcollegedetails.varContactTwo, tblcollegedetails.varCollegeEmail, tblcollegedetails.varCollegeWeb, tblcollegedetails.varPhoto, tbljobs.varDesignation, tblcollegecoordinates.varLatitude, tblcollegecoordinates.varLongitude FROM tblcollegedetails INNER JOIN tbljobs ON tblcollegedetails.intCollegeId = tbljobs.intCollegeID INNER JOIN tblcollegecoordinates ON tblcollegedetails.intCollegeId = tblcollegecoordinates.intCollegeId where tbljobs.varDesignation like '%" + Request.QueryString["institute"].ToString() + "%'");
            } 
        }
        catch (Exception ex)
        {
