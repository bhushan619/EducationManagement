<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPageUserProfileViews.master" AutoEventWireup="true" CodeFile="SearchJobs.aspx.cs" Inherits="User_SearchJobs" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-sm-9 nopadding">
                                        ...
                                        <div class="coursekatta-content">
                                            <asp:HyperLink ID="HyperLink2" runat="server" CssClass="title" Text='<%# Eval("varCollegeName") %>' NavigateUrl='<%# Convert.ToInt16(Eval("isTutor"))==0? "~/user/ViewCompanyJobs.aspx?id=" + Eval("intCollegeId"): "~/user/ViewCompanyJobs.aspx?id=" + Eval("intCollegeId")%>'> </asp:HyperLink>
